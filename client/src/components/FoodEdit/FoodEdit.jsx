...
const RestaurantEdit = () => {
    ...
    useEffect(() => {
        const fetchYachtData = async () => {
            try {
                ...
                setMaxPassengers(Restaurant.maxPassengers)
                setLocation(Restaurant.location)
                setTitle(Restaurant.title)
                setMetersLong(Restaurant.metersLong)
                setInitialPhoto(Restaurant.img)
            } catch (error) {
                console.log(error)
            }
        }
    ...
    const handleEdit = async (e) => {
        ...
        try {
            ...
            const updatedRestaurant = await request("/Restaurant/" + id, 'PUT', options, body)

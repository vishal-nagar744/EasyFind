...
const PropertyDetail = () => {
  ...
  return (
    <div className={classes.container}>
      <h3 style={{ textAlign: 'center', marginBottom: '2.5rem', fontSize: '32px', marginTop: '-2.5rem' }}>Room/Flat/Hostel Details</h3>
        ...
        <div className={classes.right}>
          ...
          <div className={classes.details}>
            ...
            <div className={classes.priceAndOwner}>
              <span className={classes.price}><span>Price: INR </span>{`${propertyDetail?.price}`}</span>
              <span style={{ display: 'flex', alignItems: 'center', gap: '12px' , padding : '15px',margin : '12px', fontWeight: '700' }}>
            ...
            <div className={classes.moreDetails}>
              ...
              <span>{propertyDetail?.sqmeters} BHK/  RK <FaSquareFull className={classes.icon} /></span>
            </div>
          </div>
          <p className={classes.desc}>
            Discription: <span>{`${propertyDetail?.desc}`}</span>
          </p>
      ...
      {success && (
        <div className={classes.success}>
          You've successfully contacted the owner of the Resturent!
        </div>
      )}
      {shortComment && (
        <div>

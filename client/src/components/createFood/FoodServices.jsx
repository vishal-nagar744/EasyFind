...
const CreateRestaurant = () => {
    ...
    const handleCreate = async (e) => {
        ...
        try {
            ...
            if (title === '' || desc === '' || price === '' || maxPassengers==='' || metersLong === '') {
                setEmptyFields(true)
                setTimeout(() => {
                    setEmptyFields(false)
                }, 2500)
            ...
            const newRestaurant = await request("/Restaurant", 'POST', options, { ...body, img: filename })
    ...
    return (
        <div className={classes.container}>
            <div className={classes.wrapper}>
                <h3>List our Near Resturent and Tifin Serivces</h3>
                <form onSubmit={handleCreate}>
                    <div className={classes.inputBox}>
                        <label>Get tiffin service / favorite restaurants Name:</label>
